...
def load_skeleton_from_h36mreader(h36mreader, skeleton_type = None):
    ...
    nodes = construct_hierarchy_from_h36m(skeleton, h36mreader, h36mreader.root_bone, 0) 
...
test_settings = {
    ...
    'h36_path' : '.',
    'h36_file' : "d:/Carousel/Prediction/siMLPe/data/h36m/S11/walking_1.txt",
    'h36_type' : "mh_cmu"
    }
...
def runmain():
    ...
    bvhskel, bvhmv = load_motion(srmd, srst)
